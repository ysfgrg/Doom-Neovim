...
_G.packer_plugins = {
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/auto-pairs"
  },
  ["dashboard-nvim"] = {
    loaded = true,
  ...
  ["gina.vim"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/gina.vim"
  },
  ["gitsigns.nvim"] = {
    loaded = true,
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/popup.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
  ...
  ["vim-prettier"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/vim-prettier"
  },
  ["vim-react-snippets"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/vim-react-snippets"
  },
  ["vim-ripgrep"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/vim-ripgrep"
  },
  vimwiki = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/vimwiki"
  },
  ["vista.vim"] = {
    loaded = true,
    path = "/home/ysf/.local/share/nvim/site/pack/packer/start/vista.vim"
  },
  ["which-key.nvim"] = {
    loaded = true,
